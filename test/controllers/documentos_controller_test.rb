...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { asunto: @documento.asunto, firma: @documento.firma, folio: @documento.folio, num_expediente: @documento.num_expediente, rpta: @documento.rpta, ubic_archivo: @documento.ubic_archivo }
    end
  ...
  test "should update documento" do
    patch :update, id: @documento, documento: { asunto: @documento.asunto, firma: @documento.firma, folio: @documento.folio, num_expediente: @documento.num_expediente, rpta: @documento.rpta, ubic_archivo: @documento.ubic_archivo }
    assert_redirected_to documento_path(assigns(:documento))
  end
